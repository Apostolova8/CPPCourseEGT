...
#ifndef LIBRARYMANAGMENTSYSTEM_HOMEWORK_TASK_H
#define LIBRARYMANAGMENTSYSTEM_HOMEWORK_TASK_H
#endif //LIBRARYMANAGMENTSYSTEM_HOMEWORK_TASK_H
/*
Task Description:
...
Requirements:
Book Class:
• Attributes: title (string), author (string), ISEN (string).
• Methods:
• A constructor that initializes the book details. display () to output the book details to the console.
Member Class:
...
Main Function:
• Create an array of Book objects and an array of -i = objects
...
In the function, create at least two objects and two.-- objects.

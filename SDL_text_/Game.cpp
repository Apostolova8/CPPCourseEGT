...
bool Game::ttf_init()
{
	...
	tempSurfaceText = TTF_RenderText_Blended(font1, "Hello, World", {0,0,255,255});	//font, text i cvqt
	...
	tempSurfaceText = TTF_RenderText_Blended_Wrapped(font1, "Hello, World\nThis wraps the text.", { 0,255,0,255 }, 300);	//teksta ako e tvarde dulug da minava na vtori i na treti red
	...
	int tw, th;
	SDL_QueryTexture(textTextureFont1, 0, 0, &tw, &th);	//vrushta visochina i shirina
	...
	clickableRect = { ww / 2 - tw / 2, wh / 2 - th / 2, tw, th };
							//koordinati na centura na ekrana

	SDL_FreeSurface(tempSurfaceText);
	TTF_CloseFont(font1);	//neshto kato destruktor
	TTF_CloseFont(font2);	//"zatvarq" fonta
